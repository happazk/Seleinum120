...
# from agileone_interface_test.base.HTMLTestRunner import HTMLTestRunner
from agileone_interface_test.base.HTMLTestRunner_PY3 import HTMLTestRunner


# 第一部分：收集脚本
from agileone_interface_test.send_email.send_email_main import send_email_qq
