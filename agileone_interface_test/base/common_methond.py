...
from agileone_interface_test.base.base_info import HEADERS, ADMIN_NAME, ADMIN_PASSWORD
from agileone_interface_test.base.interface_url import LOGIN_URL, LOGOUT_URL
