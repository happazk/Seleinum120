...
from teachers_demo_test.agileone_project.agileone.base.base_info import ADMIN_NAME,ADMIN_PASSWORD, HEADERS
from teachers_demo_test.agileone_project.agileone.base.interface_url import LOGIN_URL,NOTICE_QUERY_URL
