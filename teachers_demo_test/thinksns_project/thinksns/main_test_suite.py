...
from thinksns_test.t01_regitser import TestRegister
from thinksns_test.t02_friendly_link import TestFriendlyLink
from unittest.runner import TextTestRunner
from unittest.loader import TestLoader
from thinksns_test import t02_friendly_link
from thinksns_common.HTMLTestRunner import HTMLTestRunner
...
runner = HTMLTestRunner(stream=fp, title="ThinkSNS项目自动化测试报告", 
                        description="这是描述内容，我不晓得写啥子好。。。。。。。。")
# 执行收集到的脚本
runner.run(suite)
